...
export A_KEYBOARD="sk"                 # non-default layout — the exact thing that used to crash advanced mode
export A_ARCH="x86_64"
export A_CPU="auto"
export A_GPU="auto"
export A_BOOTLOADER="systemd-boot"     # explicit; Limine still falls back to this anyway
export A_BOOT_THEME="dark"
