...
The goal of this phase is to determine the minimum parameter constraints that any algorithm implementing Delta must satisfy to guarantee $\mathbb{E}[G] \geq G_{\text{goal}} = 0.015$.
